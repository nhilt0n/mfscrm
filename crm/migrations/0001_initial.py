# Generated by Django 3.1.1 on 2021-03-09 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_pickup_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('p_charge', models.DecimalField(decimal_places=2, max_digits=10)),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_date', models.DateTimeField(auto_now_add=True)),
